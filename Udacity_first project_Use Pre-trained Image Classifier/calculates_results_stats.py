...
def calculates_results_stats(results_dic):
    ...
    for value_list in results_dic.values():
        ...
        # pet Image is a Dog - count number of correct match and breeds
        if is_dog == 1:
            results_stats_dic['n_dogs_img'] += 1
            
            # count num correct dog matches
            if as_dog == 1:
                results_stats_dic["n_correct_dogs"] +=1
               
            # count num of correct dog breed
            if is_match == 1:
    ...
    # store count variables to calculate run statistics
